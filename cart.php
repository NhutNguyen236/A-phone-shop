                                                ...
                                                <td class="product-col">
                                                    <div class="product">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="assets/images/products/table/product-1.png" alt="Product image">
                                                            </a>
                                                        </figure>

                                                        <h3 class="product-title">
                                                            <a href="#"><?php echo $dsnv['item_name'] ?></a>
                                                        </h3><!-- End .product-title -->
                                                    </div><!-- End .product -->
                                                </td>
                                                <td class="price-col">$<?php echo $dsnv['cost'] ?></td>
                                                <td class="remove-col"><a href="./functions/deleteCart.php?id_cart=<?php echo $dsnv['id_cart'] ?>" class="btn-remove"><i class="icon-close"></i></a></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                            ...
                                            <tr class="summary-total">
                                                ...
                                                <td>
                                                    <?php 
                                                        ...
                                                        // for cart count
                                                        $row_query = "SELECT COUNT(*) FROM cart";
                                                        $row_result = mysqli_query($connection, $row_query);

                                                        $cart_count = mysqli_fetch_array($row_result)[0];
                                                        $cost = mysqli_fetch_array($result)[0];  
                                                        
                                                        // if cart count is 0 then return $0
                                                        if($cart_count == 0) {
                                                            echo "$0";
                                                        } else {
                                                            echo "$".$cost;
